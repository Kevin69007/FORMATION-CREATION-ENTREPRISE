    ...
    8: {
        ...
        content: `
            ...
            <div style="background: #e2e3e5; padding: 20px; border-radius: 8px; margin: 30px 0;">
                ...
                <ul>
                    <li><strong>Livres recommandés :</strong> "Lean Startup" d'Eric Ries, "The Lean Entrepreneur" de Brant Cooper</li>
                    <li><strong>Outils en ligne :</strong> Trello pour la gestion de projet, Canva pour le design</li>
                    <li><strong>Communautés :</strong> Rejoignez des groupes d'entrepreneurs locaux</li>
                </ul>
            </div>
        `
    }
