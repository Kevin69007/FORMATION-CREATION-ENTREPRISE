...
<h3>Adaptation de l'Offre</h3>
    ...
    5: {
        ...
        content: `
            ...
            <h2>📊 Exemple de Customer Journey Map</h2>
            
            <div style="background: #f8f9fa; padding: 20px; border-radius: 8px; margin: 20px 0;">
                <h4>Exemple : Achat d'un logiciel SaaS</h4>
                <table style="width: 100%; border-collapse: collapse;">
                    <tr style="background: #e9ecef;">
                        <th style="padding: 10px; border: 1px solid #dee2e6;">Étape</th>
                        <th style="padding: 10px; border: 1px solid #dee2e6;">Actions</th>
                        <th style="padding: 10px; border: 1px solid #dee2e6;">Émotions</th>
                        <th style="padding: 10px; border: 1px solid #dee2e6;">Améliorations</th>
                    </tr>
                    <tr>
                        <td style="padding: 10px; border: 1px solid #dee2e6;">Prise de conscience</td>
                        <td style="padding: 10px; border: 1px solid #dee2e6;">Recherche Google</td>
                        <td style="padding: 10px; border: 1px solid #dee2e6;">Frustration</td>
                        <td style="padding: 10px; border: 1px solid #dee2e6;">SEO amélioré</td>
                    </tr>
                    <tr>
                        <td style="padding: 10px; border: 1px solid #dee2e6;">Considération</td>
                        <td style="padding: 10px; border: 1px solid #dee2e6;">Comparaison</td>
                        <td style="padding: 10px; border: 1px solid #dee2e6;">Hésitation</td>
                        <td style="padding: 10px; border: 1px solid #dee2e6;">Démo personnalisée</td>
                    </tr>
                    <tr>
                        <td style="padding: 10px; border: 1px solid #dee2e6;">Décision</td>
                        <td style="padding: 10px; border: 1px solid #dee2e6;">Essai gratuit</td>
                        <td style="padding: 10px; border: 1px solid #dee2e6;">Confiance</td>
                        <td style="padding: 10px; border: 1px solid #dee2e6;">Onboarding simplifié</td>
                    </tr>
                </table>
            </div>
            
            <h2>🎯 Optimisation du parcours</h2>
            
            <h3>Stratégies d'amélioration</h3>
            <ul>
                <li><strong>Réduction des frictions :</strong> Simplifier les processus</li>
                <li><strong>Personnalisation :</strong> Adapter l'expérience</li>
                <li><strong>Proactivité :</strong> Anticiper les besoins</li>
                <li><strong>Feedback :</strong> Collecter et agir sur les retours</li>
            </ul>
    ...
    6: {
        ...
        content: `
            ...
            <div style="background: #e2e3e5; padding: 20px; border-radius: 8px; margin: 30px 0;">
                ...
                <ul>
                    <li><strong>Outils d'analyse :</strong> Google Trends, SEMrush, SimilarWeb</li>
                    <li><strong>Enquêtes clients :</strong> SurveyMonkey, Typeform</li>
