...
window.module12Content = {
    ...
    2: {
        ...
        <h2>📊 Optimisation du mix commercial</h2>
            ...
            <table style="width: 100%; border-collapse: collapse; border: 1px solid #ddd;">
                <thead>
                    <tr style="background: #f8f9fa;">
                        ...
                        <th style="border: 1px solid #ddd; padding: 12px;">Segment</th>
                        <th style="border: 1px solid #ddd; padding: 12px;">Objectif</th>
                        <th style="border: 1px solid #ddd; padding: 12px;">ROI</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td style="border: 1px solid #ddd; padding: 12px;">Email marketing</td>
                        <td style="border: 1px solid #ddd; padding: 12px;">Prospects qualifiés</td>
                        <td style="border: 1px solid #ddd; padding: 12px;">Conversion</td>
                        <td style="border: 1px solid #ddd; padding: 12px;">Élevé</td>
                    </tr>
                    <tr>
                        <td style="border: 1px solid #ddd; padding: 12px;">Téléphone</td>
                        <td style="border: 1px solid #ddd; padding: 12px;">Clients VIP</td>
                        <td style="border: 1px solid #ddd; padding: 12px;">Fidélisation</td>
                        <td style="border: 1px solid #ddd; padding: 12px;">Moyen</td>
                    </tr>
                    <tr>
                        <td style="border: 1px solid #ddd; padding: 12px;">Événements</td>
                        <td style="border: 1px solid #ddd; padding: 12px;">Tous segments</td>
    ...
    3: {
        ...
        <div style="overflow-x: auto; margin: 20px 0;">
            <table style="width: 100%; border-collapse: collapse; border: 1px solid #ddd;">
                ...
                <tbody>
                    <tr>
                        <td style="border: 1px solid #ddd; padding: 12px;">Taux de rétention</td>
                        <td style="border: 1px solid #ddd; padding: 12px;">% clients conservés</td>
                        <td style="border: 1px solid #ddd; padding: 12px;">> 80%</td>
                    </tr>
                    <tr>
                        <td style="border: 1px solid #ddd; padding: 12px;">NPS</td>
                        <td style="border: 1px solid #ddd; padding: 12px;">Net Promoter Score</td>
            ...
            <table style="width: 100%; border-collapse: collapse; border: 1px solid #ddd;">
                <thead>
                    <tr style="background: #f8f9fa;">
                        ...
                        <th style="border: 1px solid #ddd; padding: 12px;">Fréquence</th>
                        <th style="border: 1px solid #ddd; padding: 12px;">Responsable</th>
                        <th style="border: 1px solid #ddd; padding: 12px;">Action</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td style="border: 1px solid #ddd; padding: 12px;">Performance</td>
                        <td style="border: 1px solid #ddd; padding: 12px;">Hebdomadaire</td>
                        <td style="border: 1px solid #ddd; padding: 12px;">Commercial</td>
                        <td style="border: 1px solid #ddd; padding: 12px;">Rapport</td>
                    </tr>
                    <tr>
                        <td style="border: 1px solid #ddd; padding: 12px;">Budget</td>
                        <td style="border: 1px solid #ddd; padding: 12px;">Mensuel</td>
                        <td style="border: 1px solid #ddd; padding: 12px;">Manager</td>
                        <td style="border: 1px solid #ddd; padding: 12px;">Ajustement</td>
                    </tr>
                    <tr>
                        <td style="border: 1px solid #ddd; padding: 12px;">Stratégie</td>
                        <td style="border: 1px solid #ddd; padding: 12px;">Trimestriel</td>
