...
window.module9Content = {
    1: {
        ...
        <div style="background: #f8f9fa; padding: 20px; border-radius: 8px; margin: 20px 0;">
            ...
            <ul>
                <li><strong>Responsabilité :</strong> Limitation ou non du patrimoine personnel</li>
                <li><strong>Fiscalité :</strong> Impôt sur le revenu ou impôt sur les sociétés</li>
                <li><strong>Social :</strong> Régime social du dirigeant</li>
                <li><strong>Gestion :</strong> Simplicité ou complexité administrative</li>
                <li><strong>Croissance :</strong> Facilité d'évolution et de développement</li>
            </ul>
        </div>
        
        <h2>⚠️ Points d'attention</h2>
        <ul>
            <li>Le choix du statut n'est pas définitif mais peut être coûteux à changer</li>
            <li>Consultez un professionnel pour des projets complexes</li>
            <li>Anticipez l'évolution de votre projet</li>
            <li>Considérez les implications fiscales et sociales</li>
        </ul>
...
if (typeof window !== 'undefined') {
    window.module9Content = module9Content;
}