...
window.module7Content = {
    ...
    3: {
        ...
        <div style="background: #e3f2fd; padding: 20px; border-radius: 8px; margin: 20px 0;">
            <h4>Composition d'un CFE</h4>
            <ul>
                <li><strong>Direction :</strong> Encadrement et coordination</li>
                <li><strong>Service d'accueil :</strong> Information et orientation</li>
                <li><strong>Service instruction :</strong> Traitement des dossiers</li>
                <li><strong>Service juridique :</strong> Conseil et assistance</li>
            </ul>
        </div>
        ...
        <div style="background: #f3e5f5; padding: 20px; border-radius: 8px; margin: 20px 0;">
            <h4>Rôles des CFE</h4>
            <ul>
                <li><strong>Accueil :</strong> Information et orientation</li>
                <li><strong>Instruction :</strong> Traitement des dossiers</li>
                <li><strong>Transmission :</strong> Envoi aux organismes compétents</li>
                <li><strong>Suivi :</strong> Accompagnement des démarches</li>
            </ul>
        </div>
        ...
        <div style="background: #f8f9fa; padding: 20px; border-radius: 8px; margin: 20px 0;">
            <h4>Phases de traitement</h4>
            <ol>
                <li><strong>Réception :</strong> Enregistrement du dossier</li>
                <li><strong>Vérification :</strong> Contrôle des pièces</li>
                <li><strong>Instruction :</strong> Traitement administratif</li>
                <li><strong>Transmission :</strong> Envoi aux organismes</li>
                <li><strong>Notification :</strong> Information du demandeur</li>
            </ol>
        </div>
        ...
        <div style="background: #f3e5f5; padding: 20px; border-radius: 8px; margin: 20px 0;">
            ...
            <ul>
                ...
                <li><strong>Cessation :</strong> 2 à 5 jours ouvrés</li>
                <li><strong>Urgent :</strong> 24 à 48 heures</li>
            </ul>
        </div>
        
        <h2>🛠️ Services proposés</h2>
        
        <h3>Services gratuits</h3>
        <div style="background: #d4edda; padding: 20px; border-radius: 8px; margin: 20px 0;">
            <h4>Prestations incluses</h4>
            <ul>
                <li><strong>Information :</strong> Conseils généraux</li>
                <li><strong>Orientation :</strong> Direction vers les bons services</li>
                <li><strong>Instruction :</strong> Traitement des dossiers</li>
                <li><strong>Transmission :</strong> Envoi aux organismes</li>
            </ul>
        </div>
        ...
        <div style="background: #f8d7da; padding: 20px; border-radius: 8px; margin: 20px 0;">
            ...
            <ul>
                <li><strong>Conseil personnalisé :</strong> Accompagnement dédié</li>
                <li><strong>Rédaction :</strong> Assistance rédactionnelle</li>
                <li><strong>Formation :</strong> Modules spécialisés</li>
                <li><strong>Suivi :</strong> Accompagnement prolongé</li>
            </ul>
        </div>
        ...
        <div style="background: #e3f2fd; padding: 20px; border-radius: 8px; margin: 20px 0;">
            ...
            <ul>
                <li><strong>Accueil physique :</strong> Sur rendez-vous</li>
                <li><strong>Téléphone :</strong> Standard et spécialisé</li>
                <li><strong>Email :</strong> Messagerie électronique</li>
                <li><strong>Site web :</strong> Informations en ligne</li>
            </ul>
        </div>
        ...
        <ul>
            ...
            <li>Prendre rendez-vous si nécessaire</li>
            <li>Préparer ses questions à l'avance</li>
            <li>Conserver les justificatifs</li>
        </ul>
    ...
    4: {
        ...
        <h3>2. Obligations déclaratives</h3>
        <div style="background: #f3e5f5; padding: 20px; border-radius: 8px; margin: 20px 0;">
        ...
        <h3>3. Obligations de publicité</h3>
        <div style="background: #e8f5e8; padding: 20px; border-radius: 8px; margin: 20px 0;">
        ...
        <div style="background: #fff3e0; padding: 20px; border-radius: 8px; margin: 20px 0;">
            <h4>Services fiscaux</h4>
            <ul>
                <li><strong>DGFiP :</strong> Direction générale des finances publiques</li>
                <li><strong>Service des impôts :</strong> Déclarations fiscales</li>
                <li><strong>Recouvrement :</strong> Paiement des impôts</li>
                <li><strong>Contrôle :</strong> Vérifications fiscales</li>
            </ul>
        </div>
        ...
        <div style="background: #f8f9fa; padding: 20px; border-radius: 8px; margin: 20px 0;">
            ...
            <ul>
                <li><strong>URSSAF :</strong> Cotisations sociales</li>
                <li><strong>CPAM :</strong> Assurance maladie</li>
                <li><strong>CARSAT :</strong> Retraite et prévoyance</li>
                <li><strong>Pôle Emploi :</strong> Assurance chômage</li>
            </ul>
        </div>
        ...
        <div style="background: #e3f2fd; padding: 20px; border-radius: 8px; margin: 20px 0;">
            <h4>Déclarations annuelles</h4>
            <ul>
                <li><strong>Mars :</strong> Déclaration de TVA</li>
                <li><strong>Mai :</strong> Déclaration de résultats</li>
                <li><strong>Juin :</strong> Bilan et compte de résultat</li>
                <li><strong>Décembre :</strong> Déclaration de TVA</li>
            </ul>
        </div>
        
        <h3>Échéances mensuelles</h3>
        <div style="background: #f3e5f5; padding: 20px; border-radius: 8px; margin: 20px 0;">
            <h4>Déclarations mensuelles</h4>
            <ul>
                <li><strong>DSN :</strong> Déclaration sociale nominative</li>
                <li><strong>TVA :</strong> Si régime mensuel</li>
                <li><strong>CAF :</strong> Cotisations d'assurance familiale</li>
                <li><strong>Formation :</strong> Taxe d'apprentissage</li>
            </ul>
        </div>
        
        <h2>⚠️ Sanctions et contrôles</h2>
        
        <h3>Sanctions possibles</h3>
        <div style="background: #f8d7da; padding: 20px; border-radius: 8px; margin: 20px 0;">
            <h4>Pénalités</h4>
            <ul>
                <li><strong>Retard :</strong> Majorations de retard</li>
                <li><strong>Oubli :</strong> Pénalités forfaitaires</li>
                <li><strong>Erreur :</strong> Rectifications</li>
                <li><strong>Fraude :</strong> Amendes et intérêts</li>
            </ul>
        </div>
        
        <h3>Contrôles administratifs</h3>
        <div style="background: #fff3e0; padding: 20px; border-radius: 8px; margin: 20px 0;">
            <h4>Types de contrôles</h4>
            <ul>
                <li><strong>Fiscal :</strong> Contrôle fiscal</li>
                <li><strong>Social :</strong> Contrôle URSSAF</li>
                <li><strong>Comptable :</strong> Vérification comptable</li>
                <li><strong>Juridique :</strong> Contrôle de conformité</li>
            </ul>
        </div>
        ...
        <div style="background: #d4edda; padding: 20px; border-radius: 8px; margin: 20px 0;">
            ...
            <ul>
                <li><strong>Comptabilité :</strong> Logiciels comptables</li>
                <li><strong>Paie :</strong> Gestion de la paie</li>
                <li><strong>Fiscal :</strong> Déclarations fiscales</li>
        ...
        <div style="background: #e8f5e8; padding: 20px; border-radius: 8px; margin: 20px 0;">
            <h4>Portails administratifs</h4>
            <ul>
                <li><strong>Service-public.fr :</strong> Démarches en ligne</li>
                <li><strong>Impots.gouv.fr :</strong> Déclarations fiscales</li>
                <li><strong>Urssaf.fr :</strong> Déclarations sociales</li>
                <li><strong>Net-entreprises.fr :</strong> Formalités entreprises</li>
            </ul>
        </div>
